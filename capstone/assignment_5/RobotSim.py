...
class RobotSim(object):
    ...
    def __init__(self, markers, occupancy_map, pos_init, goal_pos, max_speed,
        ...
        metadata = dict(title='Capstone_Assn_5', artist='Matplotlib',
                comment='Kalman filter demo')
    ...
    def update_frame(self):
        ...
        # uncomment to save images to make movie
        """
        if self.__frame_num < 10:
            s = "000" + str(self.__frame_num)
        elif self.__frame_num < 100:
            s = "00" + str(self.__frame_num)
        else:
            s = "0" + str(self.__frame_num)
        plt.savefig("images/image{}.png".format(s))
        """
