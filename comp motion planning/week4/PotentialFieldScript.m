...
video=1;
if video
  video_writer = VideoWriter('grad_plan.avi', 'Uncompressed AVI');
  open(video_writer);
end
[sx, sy, sz] = sphere(20);
...
quiver (x(yidx,xidx), y(yidx,xidx), gx(yidx,xidx), gy(yidx,xidx), 0.6);
